...
const AddAdvertiser = (props) => {
  ...
  const submitted = (e) => {
    ...
    //     nextStep()} )
    //   .catch(err=>{  setLoading(false); console.error('Error '+err)} ) 
    nextStep()
  }
  return (
    <div>
                    ...
                    <Col md={6}>
                      <FormGroup>
                        ...
                        <Input type="text" name="firstName2" placeholder="First Name" value={PageOne['firstName2']}
                          onChange={ e=>setPageOne({ ...PageOne, [e.target.name]: e.target.value })} />
                      </FormGroup>
                    </Col>
                    <Col md={6}>
                      <FormGroup>
                        ...
                        <Input type="text" name="lastName2" placeholder="Last Name"
                          value={PageOne['lastName2']} onChange={e=>setPageOne({ ...PageOne, [e.target.name]: e.target.value })} />
                      </FormGroup>
                    </Col>
                  </Row>
                  <Row >
                    <Col md={6}>
                      <FormGroup>
                        ...
                        <Input type="email" name="email2" placeholder="Enter Email"
                          value={PageOne['email2']} onChange={e=>setPageOne({ ...PageOne, [e.target.name]: e.target.value })} />
                      </FormGroup>
                    </Col>
                    <Col md={6}>
                      <FormGroup>
                        ...
                        <Input type="text" name="phone2" placeholder="Enter Contact Number"
                          value={handleInput(PageOne['phone2'])} onChange={e=>setPageOne({ ...PageOne, [e.target.name]: e.target.value })} />
                      </FormGroup>
                    </Col>
                  </Row>
                </div>
