...
const Page2=(props)=>{
    ...
    const handleChange = (e) => {
      const isValid = RegexValidation(e.target.value, e.target.name)
      // console.log(isValid)
      ...
      <h4 style={{textAlign:'left',color:'blue'}}>Add New Orders</h4> 
        ...
        <Col md={6}>
          <FormGroup>
            ...
            <Input type="title" name="title" placeholder="Title" 
             onChange={handleChange} invalid={!validation['title'].valid && validation['title'].touched} />
        ...
        <FormGroup>
            ...
            <Input type='text' name="landingUrl" placeholder="www.testbacancy.com" 
             onChange={handleChange} invalid={!validation['landingUrl'].valid && validation['landingUrl'].touched}/>
        ...
        <Col md={6}>
          <FormGroup>
            ...
            <Input type="" name="price" placeholder="Price" 
             onChange={handleChange} invalid={!validation['price'].valid && validation['price'].touched} />
        ...
        <Col md={6}>
          <FormGroup>
            ...
            <Input style={{height:'100px'}} type="textarea" name="description" placeholder="Description"
             onChange={handleChange} invalid={!validation['description'].valid && validation['description'].touched} />
        ...
        <Col md={6}>
          <FormGroup>
            ...
            <Input type="number" name="budget" placeholder="$0"
             onChange={handleChange} invalid={!validation['budget'].valid && validation['budget'].touched}/>
    ...
    <Row>
        ...
        <Button color="black" style={{boxShadow: '0px 8px 15px rgba(0, 0, 0, 0.1)',margin:'10px'}}>Cancle</Button>
          <Button color="primary"  style={{boxShadow: '0px 8px 15px rgba(0, 0, 0, 0.1)',margin:'10px'}}
          onClick={props.nextStep} disabled={!isFomValid}
